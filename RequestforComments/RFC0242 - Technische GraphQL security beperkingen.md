...
Volg deze [link](https://github.com/iStandaarden/iWlz_RequestForChange/issues/242) om de actuele status van deze RFC te bekijken.
...
- [2. Terminologie](#2-terminologie)
  - [Diagram of schema opnemen in RFC](#diagram-of-schema-opnemen-in-rfc)
    - [Creating Mermaid diagrams](#creating-mermaid-diagrams)
